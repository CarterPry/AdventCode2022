...
This repository contains my solutions for the [Advent of Code 2022](https://adventofcode.com/) challenge, written in C++. Advent of Code is an annual event where participants solve daily programming puzzles in the weeks leading up to Christmas.

## Getting Started

To run the solutions, you will need a C++ compiler installed on your machine. I recommend using [gcc](https://gcc.gnu.org/) or [clang](https://clang.llvm.org/).
